    ...
    for (let i = 0; i < files.length; i++) {
        ...
        reader.onload = function (e) {
            ...
            if (imageArray.length === files.length) {
                ...
                updateImagesSrcContainer(imageArray);   // update the value of images input field (hidden) which will be used in the backend
...
function updateImagesSrcContainer(imageArray) {
